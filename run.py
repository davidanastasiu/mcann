...
class Options():
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--train_volume', type=int, default=4000, help='train set size')
        self.parser.add_argument('--hidden_dim', type=int, default=512, help='hidden dim of basic layers')
        self.parser.add_argument('--atten_dim', type=int, default=600, help='hidden dim of attention layers')
        ...
        self.parser.add_argument('--input_len', type=int, default=15*24, help='length of input vector')
        self.parser.add_argument('--output_len', type=int, default=24*3, help='length of output vector')
        
        self.parser.add_argument('--val_size', type=int, default=60, help='validation set size')       
        self.parser.add_argument('--start_point', type=str, default='1991-07-01 23:30:00', help='start time of the train set')
        self.parser.add_argument('--train_point', type=str, default='2018-06-30 23:30:00', help='end time of the train set')
        self.parser.add_argument('--test_start', type=str, default='2018-07-01 00:30:00', help='start time of the test set')
        self.parser.add_argument('--test_end', type=str,  default='2019-07-01 00:30:00', help='end time of the test set')
        self.parser.add_argument('--watershed', type=int, default=0, help='1 if trained with rain info， else with GMM indicator')
        self.parser.add_argument('--oversampling', type=str, default=40, help='ratio of training data with extreme points.')
        
        self.parser.add_argument('--gpu_id', type=int, default=3, help='gpu ids: e.g. 0. use -1 for CPU')
        self.parser.add_argument('--ngpu', type=int, default=1, help='number of GPUs to use')
        
        self.parser.add_argument('--model', type=str, default="4009", help='model label')
